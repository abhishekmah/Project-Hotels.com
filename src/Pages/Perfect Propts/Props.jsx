      ...
      <div className="section2">
        ...
        <div className="location">
          ...
          <div className="review">
            <div>
              <section class="_3Ddcd6">
                <div class="_2DxHMR gulKMN">
                  <div class="_3eVx_d">
                    <span className="reviewRating">
                      9.2<span class="is-visually-hidden">.</span>
                    </span>
                    <span class="_3OCzLl">
                      <span class="_3nZdfb">
                        Superb<span class="is-visually-hidden">.</span>
                      </span>
                      <span class="_1VEuhR">
                        <span class="_3zLN_v Y_8VbY b3TRQj">
                          <span
                            role="button"
                            class="k3LKyj"
                            aria-expanded="false"
                ...
                <ul class="_3YvFHN _2z8StZ">
                  <li class="_1BIjNY">
                    <q class="oZl9tt">
                      The hotel is in the middle of the park, and all the
                      activities are within short distance.…
                    </q>
                    <p class="_3Uw-k7">Dec 4, 2019</p>
                  </li>
                  <li class="_1BIjNY">
                    <q class="oZl9tt">Amazing customer service</q>
                    <p class="_3Uw-k7">Dec 2, 2019</p>
                  </li>
                </ul>
                See all 7 reviews
                <button class="_1HtKl_" aria-label="See all 7 reviews"></button>
              </section>
            </div>
          </div>
        </div>
            ...
            <div class="_1FepWS">
              <span class="_1Ac6YH _2NVtuq _1DW1ZH ZCedaV">
                <img
                  ...
                  src="https://maps-api-ssl.google.com/maps/api/staticmap?center=-51.116134,-72.990977&amp;zoom=13&amp;size=423x160&amp;format=jpg&amp;sensor=false&amp;channel=hotels.com-web.desktop.property.description&amp;scale=2&amp;key=AIzaSyDaDqDNrxWrxcURixO2l6TbtV68X0Klf4U&amp;signature=VgKJsQAzMwJsNZFtP7GaNva3oqE="
                  alt=""
                />
              </span>
              <div class="FebmkO">
            ...
            <div class="_2Ut1Ms">
              ...
              <ul>
                <li>
                  ...
                  including need for pre-travel COVID-19 testing and quarantine
                  on arrival.
                </li>
              </ul>
        ...
        <section class="_1O0SKi">
          <section class="_1_22qw _3vsObg">
            ...
            <div class="_2Ut1Ms _2AtLn6">
              ...
              <div>
                <p>
                  For transfers, guests must contact the property before arrival
              ...
              <div>
                <ul>
                  <li>
                    ...
                    non-residents staying in the country for 60 consecutive days
                    or more. To qualify for a tax exemption, travelers must pay
                    for their stay in foreign currency (not in Chilean pesos)
            ...
            <p>
              ...
              However, charges can vary, for example, based on length of stay or
              the unit you book.
            </p>
          </section>
        </section>
        ...
        <nav aria-label="Breadcrumb" class="_3qDcNM">
          ...
          >
            ...
            >
              ...
              <a href="/" rel="noopener noreferrer" itemprop="item">
            ...
            >
              ...
              <a
                ...
                itemprop="item"
              >
                <span itemProp="name">Chile Hotels</span>
              </a>
            </li>
            <li
              itemscope=""
            ...
            >
              ...
              <a
                ...
                itemprop="item"
              >
                <span itemProp="name">Torres Del Paine Hotels</span>
              </a>
            </li>
            <li
              itemscope=""
            ...
            >
              ...
              <div
                ...
                itemid="#"
              >
                <span itemProp="name" aria-current="page" aria-hidden="true">
                  explora Patagonia
                </span>
              </div>
            </li>
